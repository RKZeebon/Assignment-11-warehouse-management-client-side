    ...
    return (
        <div className='mt-4'>
            <div className='relative p-2 rounded-lg  md:min-h-[550px] shadow-xl shadow-blue-400'>
                ...
                <div onClick={() => handleDelete(_id)} className='bg-red-200 absolute left-0 right-0 bottom-0 rounded-br-lg rounded-bl-lg text-2xl text-center text-red-600 hover:bg-[#f70000] hover:text-red-200'><button className='font-semibold w-full py-3'>Remove</button></div>
            </div>
