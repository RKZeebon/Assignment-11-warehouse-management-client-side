        ...
        <div className='min-h-[850px]'>
            ...
            <div className='w-2/3 lg:w-1/3 mx-auto my-8 py-5 shadow-2xl shadow-blue-400 px-2 rounded-lg'>
                ...
                <form>
                    ...
                    <div className='bg-blue-400 py-2 text-center my-5 rounded-md hover:bg-[royalblue] hover:text-white cursor-pointer'><input className='text-2xl font-Roboto font-semibold cursor-pointer' type="submit" value="Login" /></div>
                </form>
                ...
                <div>
                    <div className='text-center bg-blue-400 my-3 py-2 rounded-md'>
