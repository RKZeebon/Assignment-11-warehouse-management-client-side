    ...
    return (
        <div className='min-h-[850px]'>
            ...
            <div className='w-2/3 lg:w-1/3 mx-auto my-8 pt-5 pb-10 shadow-2xl shadow-blue-400 px-2 rounded-lg'>
                ...
                <form>
                    <div>
                        <input className='text-xl my-3 border-2 border-black w-full p-2 rounded-md' type="text" name="name" id="" placeholder='Enter Your Name' />
                    </div>
                    <div>
                    ...
                    <div>
                        <input className='text-xl my-3 border-2 border-black w-full p-2 rounded-md' type="password" name="pass" id="" placeholder='Enter Password' />
                    </div>
                    <div>
                        <input className='text-xl my-3 border-2 border-black w-full p-2 rounded-md' type="password" name="confirmPass" id="" placeholder='Confirm Password' />
                    </div>
